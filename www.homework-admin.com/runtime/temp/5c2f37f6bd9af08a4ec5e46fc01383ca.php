<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"/www/wwwroot/www.homework-admin.com/public/../application/index/view/platform/good.html";i:1609500309;s:70:"/www/wwwroot/www.homework-admin.com/application/index/view/layout.html";i:1609316590;}*/ ?>
<!doctype html>
...
<body>
            ...
            $.ajax({
                ...
                success: function (flag) {
                    if (flag == 0) {
                        ...
                        var url = "<?php echo url('@index/platform/save', 't=good&c0=_c0&c1=_c1&c2=_c2&c3=_c3&c4=_c4&c5=_c5'); ?>";
            ...
            $.ajax({
                ...
                success: function (flag) {
                    if (flag == 0) {
                        ...
                        var url = "<?php echo url('@index/platform/delete', 't=good&c0=_c0'); ?>";
    ...
    function add_good() {
        window.location.href = "<?php echo url('@index/platform/add'); ?>" + "?t=good";
    }
    </script>
